...
import {
    Navbar, NavbarBrand, Label, Nav, Input, Form,
    FormGroup, NavItem, NavbarToggler, Collapse, Jumbotron,
                ...
                <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                    ...
                    <ModalBody>
                        <Form onSubmit={this.handleLogin}>
                            ...
                            <FormGroup check>
                                <Label check>
                                    <Input type="checkbox" name="rememberme" innerRef={(input) => this.rememberme = input} />Remember me
                                </Label>
                            </FormGroup>
